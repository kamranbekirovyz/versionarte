...
class _ServersideVersioning {
  ...
  /// Instantiates a `_ServersideVersioning` instance from json.
  ///
  /// See example json file at path "/versionarte.json".
  factory _ServersideVersioning.fromJson(Map<String, dynamic> json) {
  ...
  /// Returns latest version of the currently running platform.
  String get latestPlatformReadableVersion => Platform.isAndroid
      ? latestReadableAndroidVersion
      : latestReadableIosVersion;
